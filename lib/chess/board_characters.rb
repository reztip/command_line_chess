...
module Chess
  ...
  rep_map = {nil => "", :pawn => {:black => BLACK_PAWN_REPRESENTATION, :white => WHITE_PAWN_REPRESENTATION}, :king => {:white => WHITE_KNIGHT_REPRESENTATION, :black => BLACK_KING_REPRESENTATION},
